...
- For AltStore user: 
  ...
  - [Open in AltStore (v17.43.1-2.1)](https://tinyurl.com/vfm32bjy) - It will take a while to install because AltStore needs to download the IPA first.

- Version info: _(last update: Nov 06)_
